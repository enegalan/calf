...
- `docker_socket_proxy.go` — public `docker.sock`: wake-on-connect listen when the engine is stopped; direct symlink to the guest vsock while running; periodic reclaim after upgrade races.
