...
- `docker_socket_proxy.go` — public `docker.sock`: wake-on-connect listen; reads HTTP before dialing vsock; API version clamp; serialized vsock dials via the guest gater; periodic reclaim after upgrade races.
